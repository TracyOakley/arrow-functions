...
//  The Student object "joe"

// 2. What is "this" when joe.scopeArrow() is invoked?
//  The Window object

// 3. Explain why "this" is different when an arrow function is used.
//  the "this" of the arrow function refers to the "this" of the surrounding scope which is the Window and the "this" of the normal function will refer to the Student object.
//   the "this" context is not reset within an arrow function. The value of "this" is therefore the same as the "this" of the enclosing scope (the surrounding non-arrow function). If there isn’t a non-arrow function scope surrounding, the "this" context will be, in the browser, the global window object. 
//It happens because arrow functions retain the "this" value of the enclosing functional scope. Therefore, you will want to avoid using an arrow function in a constructor (where we need the contextual "this" to be the object we are building) or any method that needs to use "this" to behave properly.
